...
vendas_mensal = pd.DataFrame(
    dados.set_index("Data da Compra").groupby(pd.Grouper(freq="M"))["Preço"].count()
).reset_index()
vendas_mensal["Ano"] = vendas_mensal["Data da Compra"].dt.year
vendas_mensal["Mes"] = vendas_mensal["Data da Compra"].dt.month_name()

vendas_categorias = pd.DataFrame(
    dados.groupby("Categoria do Produto")["Preço"].count().sort_values(ascending=False)
)
...
aba1, aba2, aba3 = st.tabs(["Receita", "Quantidade de Vendas", "Vededores"])
